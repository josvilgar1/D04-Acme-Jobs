...
<acme:list >
	<acme:list-column code="administrator.companyrecord.list.label.name" path="name" width="30%"/>
	<acme:list-column code="administrator.companyrecord.list.label.sector" path="sector" width="30%"/>	
	<acme:list-column code="administrator.companyrecord.list.label.phone" path="phone" width="40%"/>		
