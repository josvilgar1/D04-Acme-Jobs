...
<acme:form>
	...
	<jstl:if test="${command == 'create'}">
		<acme:form-checkbox code="provider.request.form.label.check" path="check"/>
	</jstl:if>
	
	<acme:form-submit test="${command == 'create'}"
		code="provider.request.form.button.create" 
		action="/provider/request/create"/>
  	<acme:form-return code="provider.request.form.button.return" action="/provider/request/list-all-active"/>
</acme:form>
